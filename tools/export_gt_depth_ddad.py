...
root_path = '/mnt/james/data/CylinderDepth/data/ddad/ddad_train_val'
...
root_path = '/mnt/james/data/CylinderDepth/data/ddad/depth'
camera_names = ['CAMERA_01', 'CAMERA_05', 'CAMERA_06', 'CAMERA_07', 'CAMERA_08', 'CAMERA_09']

with open('/mnt/james/data/CylinderDepth/data/ddad/index.pkl', 'rb') as f:

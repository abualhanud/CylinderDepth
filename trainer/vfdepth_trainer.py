...
class VFDepthTrainer:
    ...
    def evaluate(self, model,vis_results=False):
        ...
        avg_depth_errors_consistency = defaultdict(float)
        ...
        for batch_idx, inputs in enumerate(process):   
            ...
            depth_eval_metric, depth_eval_median,depth_eval_metric_cams, depth_errors_consistency = self.logger.compute_depth_losses(inputs, outputs)
            ...
            for key in self.depth_metric_names:
                ...
                avg_depth_errors_consistency[key] += depth_errors_consistency[key]
                for cam in range(self.num_cams):
        ...
        for key in self.depth_metric_names:
            ...
            avg_depth_errors_consistency[key] /= len(eval_dataloader)
            for cam in range(self.num_cams):
        ...
        self.logger.print_perf(avg_depth_errors_consistency, 'consistency')
        return avg_depth_eval_metric,avg_depth_eval_median,avg_depth_eval_metric_cams, avg_depth_errors_consistency
